Font Management System for WinWing FMC (MCDU or PFP 3N / PFP 4 / PFP 7)

The plugin is able to read out this folder and load custom fonts
into the FMC in X-Plane.
Please also see -website- for creating custom fonts.

## Installation

### Folder Location
Custom fonts must be placed in the following directory:
`X-Plane root directory/Resources/plugins/winwing/fonts/`
...
1. Open X-Plane
2. Navigate to: Plugins > Winwing > FMC > Display font
...
- **No custom font**: Reverts to the default font included with the WinWing FMC hardware.
