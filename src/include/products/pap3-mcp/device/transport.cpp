...
namespace pap3::device::transport {
    ...
    static inline bool haveWriter() noexcept {
    ...
    namespace {
        ...
        static constexpr uint8_t kPayloadPreamble[] = {
            0x0F, 0xBF, 0x00, 0x00, 0x02, 0x01, 0x00, 0x00, 0xDF, 0xA2, 0x50, 0x00, 0x00, 0xB0};
        ...
        static constexpr uint8_t kInitTail[] = {
            0x0F, 0xBF, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00, 0x26, 0xCC, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00};

        // Helpers
        inline void zero64(uint8_t *b) {
            std::memset(b, 0, kReportLen);
        }
